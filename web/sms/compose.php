...
if (checkValid($id, $usr, $name)) {
    ...
    $page->title = "Compose SMS" . $SOFTNAME;
    $page->article_title = "Compose SMS" . $SOFTNAME;
    $page->PrintHeadTop();
    ?>
    <script type="text/javascript">
        $(function () {
            ...
            $("#send").click(function () {
                ...
                var request = $.ajax({
                    type: "POST",
                    url: "/do.php?device=<?=$name?>&main=sms&sub=send",
    ...
    <table style="border-style: dotted; border-width: 5px;" cellpadding="15" align="center">
        <tr>
            <td>
                ...
                <div id="composer">
                    <a href="#" class="metro"
                       onclick="javascript:window.location='fakesms.php?device=<?= $name ?>&msg='+encodeURIComponent($('#msg').val())+'&phone='+encodeURIComponent($('#to').val());">Create
                        a Fake SMS</a><br/>
